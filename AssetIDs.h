...
#define IID_SPRITE_ORANGE_PLATFORM_END (ID_SPRITE_ORANGE_PLATFORM+3000)

#define ID_SPRITE_BIG_GRASS 70000
#define ID_SPRITE_BIG_GRASS_TOP (ID_SPRITE_BIG_GRASS+1000)
#define ID_SPRITE_BIG_GRASS_TOP_LEFT (ID_SPRITE_BIG_GRASS+2000)
#define ID_SPRITE_BIG_GRASS_TOP_RIGHT (ID_SPRITE_BIG_GRASS+3000)
#define ID_SPRITE_BIG_GRASS_BODY (ID_SPRITE_BIG_GRASS+4000)